...
Ada **Developer** yang mampu menulis dengan tingkat keamanan yang baik, ada juga **developer** yang menulis kode untuk sekedar jalan saja, **"just works"** tanpa memahami kerentanan (**Vulnerability**) dari kode yang di tulisnya.

**DevSecOps** adalah terminologi keren yang lagi populer di kalangan **DevOps**, disini peran seorang **DevOps Engineer** harus bisa mengawali pengembangan sistem yang aman dari awal sampai akhir. **Secure By Design** dalam membangun **infrastructure** dan **application** yang aman harus sudah disusun dari awal.
